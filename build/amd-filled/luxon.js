define(["exports"], function(exports) {
  ...
  $Symbol[PROTOTYPE$2][TO_PRIMITIVE] ||
    _hide($Symbol[PROTOTYPE$2], TO_PRIMITIVE, $Symbol[PROTOTYPE$2].valueOf); // 19.4.3.5 Symbol.prototype[@@toStringTag]
  ...
  var repeat = _entryVirtual("String").repeat;
  ...
  var isValidZone = memoize(function(zone) {
    try {
  ...
  var IANAZone =
    ...
    (function(_Zone) {
      ...
      IANAZone.isValidZone = function isValidZone$1(zone) {
      ...
      _proto4.eras = function eras$1(length, defaultOK) {
        ...
        return listStuff(this, length, defaultOK, eras, function() {
          ...
          if (!_this4.eraCache[length]) {
            _this4.eraCache[length] = [DateTime.utc(-40, 1, 1), DateTime.utc(2017, 1, 1)].map(
              function(dt) {
  ...
  function parse(s) {
    ...
    for (
      var _len3 = arguments.length, patterns = new Array(_len3 > 1 ? _len3 - 1 : 0), _key3 = 1;
      _key3 < _len3;
      _key3++
    ) {
    ...
    (function() {
      ...
      Interval.fromISO = function fromISO(text, opts) {
        ...
        return Interval.invalid(
          "unparsable",
          'the input "' + text + "\" can't be parsed asISO 8601"
        );
      };
      /**
      ...
      if (units.indexOf(unit) >= 0) {
        ...
        if (highWater > later) {
          ...
          cursor = highWater.minus(
            ((_highWater$minus = {}), (_highWater$minus[unit] = 1), _highWater$minus)
          );
          delta -= 1;
        } else {
          cursor = highWater;
  ...
  function _diff(earlier, later, units, opts) {
    ...
    if (lowerOrderUnits.length === 0) {
      if (highWater < later) {
        ...
        highWater = cursor.plus(
          ((_cursor$plus2 = {}), (_cursor$plus2[lowestOrder] = 1), _cursor$plus2)
        );
      }
    ...
    if (lowerOrderUnits.length > 0) {
      ...
      return (_Duration$fromMillis = Duration.fromMillis(remainingMillis, opts)).shiftTo
  ...
  var DateTime =
    ...
    (function() {
      ...
      _proto.resolvedLocaleOpts = function resolvedLocaleOpts(opts) {
        ...
        var _Formatter$create$res = Formatter.create(this.loc.clone(opts), opts).resolvedOptions(
            this
          ),
